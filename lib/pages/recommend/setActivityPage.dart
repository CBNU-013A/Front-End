// pages/recommend/setActivityPage.dart
import 'package:final_project/pages/home/HomePage.dart';
import 'package:final_project/pages/recommend/setSeasonPage.dart';
...
class Setactivitypage extends StatefulWidget {
  const Setactivitypage({super.key});

  @override
  State<Setactivitypage> createState() => _SetactivitypageState();
}

class _SetactivitypageState extends State<Setactivitypage> {
  String category = '';
        ...
        onPressed: () async {
          ...
          if (newValue.isNotEmpty && !isNoneOption) {
            ...
            if (matched['_id'] != null) {
              ...
              await prefs.setString('selectedActivityKeywordId', selectedId);
              await prefs.setString('selectedActivityKeyword', newValue);
              debugPrint(
                  "✅ 저장된 subcategory id: $selectedId, keyword: ${prefs.getString('selectedActivityKeyword')}");
            }
          } else {
            await prefs.remove('selectedActivityKeywordId');
          }
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  const Setseasonpage(), // NextPage를 실제 이동할 페이지로 교체하세요.
            ),
          );
        },
        child: Text(
                  ...
                  child: Container(
                    ...
                    child: keywords.isEmpty
                        ...
                        : Wrap(
                            ...
                            children: [
                              ...keywords
                                  .map((keyword) => _buildOptionButton(keyword))
                                  .toList(),
